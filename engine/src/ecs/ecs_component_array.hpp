        ...
        class ECSComponentArray : public ECSComponentArrayInterface
        {
            public:
                ...
                void remove(ECSEntity entity)
                {
                    ...
                    size_t index_removed_entity = entity_to_index_[entity];
                    size_t index_last_entity = nb_components_ - 1;
            ...
            private:
                ...
                std::unordered_map<ECSEntity, size_t> entity_to_index_;

                // Map from an array index to an entity ID.
                std::unordered_map<size_t, ECSEntity> index_to_entity_;
