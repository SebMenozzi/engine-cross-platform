...
namespace Diligent
{
    ...
    void AtmosphereSample::Initialize(const SampleInitInfo& InitInfo)
    {
        ...
        m_strRawDEMDataFile = "heightmap.tif";
        m_strMtrlMaskFile = "mask.png";
        m_strTileTexPaths[0] = "gravel_DM.dds";
        m_strTileTexPaths[1] = "grass_DM.dds";
        m_strTileTexPaths[2] = "cliff_DM.dds";
        m_strTileTexPaths[3] = "snow_DM.dds";
        m_strTileTexPaths[4] = "grassDark_DM.dds";
        m_strNormalMapTexPaths[0] = "gravel_NM.dds";
        m_strNormalMapTexPaths[1] = "grass_NM.dds";
        m_strNormalMapTexPaths[2] = "cliff_NM.dds";
        m_strNormalMapTexPaths[3] = "snow_NM.jpg";
        m_strNormalMapTexPaths[4] = "grass_NM.dds";
    ...
    void AtmosphereSample::setupImGuiStyle()
    {
        ...
        style.Colors[ImGuiCol_TextDisabled]          = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_WindowBg]              = black;
        style.Colors[ImGuiCol_PopupBg]               = black;
        style.Colors[ImGuiCol_Border]                = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_BorderShadow]          = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_FrameBg]               = black;
        style.Colors[ImGuiCol_FrameBgHovered]        = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_FrameBgActive]         = ImVec4(1.0f, 1.0f, 1.0f, 0.8f);
        style.Colors[ImGuiCol_TitleBg]               = black;
        style.Colors[ImGuiCol_TitleBgCollapsed]      = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        ...
        style.Colors[ImGuiCol_ScrollbarGrabHovered]  = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_ScrollbarGrabActive]   = ImVec4(1.0f, 1.0f, 1.0f, 0.8f);
        ...
        style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(0.0f, 1.0f, 0.0f, 0.5f);
        style.Colors[ImGuiCol_ButtonActive]          = ImVec4(0.0f, 1.0f, 0.0f, 0.8f);
        style.Colors[ImGuiCol_Header]                = black;
        style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(1.0f, 1.0f, 1.0f, 0.5f);
        style.Colors[ImGuiCol_HeaderActive]          = ImVec4(1.0f, 1.0f, 1.0f, 0.8f);
        style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(1.0f, 1.0f, 1.0f, 0.8f);
        style.Colors[ImGuiCol_PlotLines]             = green;
        style.Colors[ImGuiCol_PlotLinesHovered]      = ImVec4(0.0f, 1.0f, 0.0f, 0.5f);
        style.Colors[ImGuiCol_PlotHistogram]         = green;
        style.Colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(0.0f, 1.0f, 0.0f, 0.5f);
    ...
    void AtmosphereSample::UpdateUI()
    {
        ...
        if (ImGui::Begin("Settings", nullptr, ImGuiWindowFlags_AlwaysAutoResize))
        {
            ImGui::gizmo3D(
                "Light direction",
                static_cast<float3&>(m_f3LightDir),
                        ...
                        {
                            {
                                ...
                                ImGui::HelpMarker(
                                    "Total number of epipolar slices (or lines). For high quality effect, set this value to (Screen Width + Screen Height)/2"
                                );
                            }

                            {
                                ...
                                ImGui::HelpMarker(
                                    "Maximum number of samples on a single epipolar line. For high quality effect, set this value to (Screen Width + Screen Height)/2"
                                );
                            }
    ...
    void AtmosphereSample::CreateShadowMap()
    {
        ...
        SMMgrInitInfo.ShadowMode = SHADOW_MODE_EVSM4;
    ...
    void AtmosphereSample::RenderShadowMap(
